package ru.dankoy.datastructures.priorityqueuearray;// The implementation of priority queue based on array (the slower implementation of queue than if it is based on  heap).
